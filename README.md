...
- Покрывал юнит тестами компоненты и функции, чтобы убедиться в корректной работе критических частей приложения.
- Тестировал асинхронные операции и обработку ошибок при запросах к API.
- Создавал тесты для проверки рендеринга компонентов и взаимодействий с пользователем, таких как клики и ввод данных.
